...
namespace bingo_bingo
{
    public partial class Form1 : Form
    {
        ...
        private void btnLottery_Click(object sender, EventArgs e)
        {
            ...
            //testLotte();
            lotteRandom();
            bonus bonus1 = new bonus(lotteTypeStar, lotteTypeSize, lotteTypeEven);
            ...
            if(lotteTypeStar>=8)
            {
                ...
                bonus1.winNum = winSter;
                bonus1.supNum = (winStrArray[1].IndexOf($"{supLotteNumber}")!=-1);
                playType += $" {lotteTypeStar-100}星 ";
                winNumber = $"中了{winSter}個號碼 超級號:{supLotteNumber}\n{winStrArray[1]}";

                //MessageBox.Show("投注成功");
            }
            if(lotteTypeSize !=0)//大小
            {
                winBigSamll = $"1~40有{20-winSize()}個 41~80有{winSize()}個\n";
            ...
            {
                winEvenSingle = $"單數有{20-winEven()}個 雙數有{winEven()}個\n";
